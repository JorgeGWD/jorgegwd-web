            ...
            <div className="skills content">
                <div className="skills__box">
                    <section>
                        ...
                        <a className="ghost__btn" href="https://drive.google.com/file/d/1rGhgN6GoVMGyQdR8Az12ksAxpXtUoUCg/view?usp=sharing" target="_blank" rel="noopener noreferrer" >
                        <Button className={"ghost__btn"} text="Download CV" /></a>
                    </section>
                </div>
            </div>
        </div>
